...
async def main():
    ...
    response = await agent.invoke("Đọc nội dung file F:/numbers.txt, lấy số đầu tiên trong file, sau đó tính bình phương của số đó và lưu kết quả vào file F:/result.txt.")
